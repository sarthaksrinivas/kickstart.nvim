...
```sh
git clone https://github.com/sarthaksrinivas/kickstart.nvim.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
...
```
git clone https://github.com/sarthaksrinivas/kickstart.nvim.git "%localappdata%\nvim"
```

If you're using `powershell.exe`

```
git clone https://github.com/sarthaksrinivas/kickstart.nvim.git "${env:LOCALAPPDATA}\nvim"
```
...
* Why is the kickstart `init.lua` a single file? Wouldn't it make sense to split it into multiple files?
  ...
  * Discussions on this topic can be found here:
    * [Restructure the configuration](https://github.com/sarthaksrinivas/kickstart.nvim/issues/218)
    * [Reorganize init.lua into a multi-file setup](https://github.com/sarthaksrinivas/kickstart.nvim/pull/473)
...
[here](https://github.com/sarthaksrinivas/kickstart.nvim/issues/1583).
